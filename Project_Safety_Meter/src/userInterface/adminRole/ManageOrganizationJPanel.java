...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateTable(){
        ...
        model.setRowCount(0);
        for(Integer organizationKeys : directory.getOrganizationDirectory().keySet()){
           
            Organization organization = directory.getOrganizationDirectory().get(organizationKeys);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add a New Organization");
